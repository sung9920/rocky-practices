...
2. [/etc/sysctl.conf](https://github.com/sung9920/rocky-practices/blob/main/lx/etc/sysct3.conf) 설정
```sh
...
2. 두 번째부터 수정 가능
   [/etc/NetworkManager/system-connectios/enp0s1.nmconnection](https://github.com/sung9920/rocky-practices/blob/main/lx/etc/NetworkManager/system-connectios/enp0s1.nmconnection)
