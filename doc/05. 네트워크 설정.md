...
2. 두 번째부터 수정 가능
   [/etc/NetworkManager/system-connectios/enp0s1.nmconnection](https://github.com/sung9920/rocky-practices/blob/main/lx/etc/NetworkManager/system-connectios/enp0s3.nmconnection)
